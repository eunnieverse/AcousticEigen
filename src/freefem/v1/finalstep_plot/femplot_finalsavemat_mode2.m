...
cd(basedir); 
cd('freefem/Mode2_plot/');
filebase = 'NewtCyl_Mode2_phi90_err005_finalstep';
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% set constants
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
T0=293.; 			   % [K]
...
klpi=data(17:end,1); %%% Omega is in the order of 2*pi*10^(-6)*/lambda.
xlength=length(klpi);
%klpi_100=logspace(log10(0.05),log10(5),100);
Omega = klpi*c0*pi/L;
rho=data(17:end,2)+data(17:end,3).*1i; 
chi=data(17:end,4)+data(17:end,5).*1i; 
Kbulk = 1./chi; 
filename = strcat(filebase,'_kc.txt'); data=load(filename);
k=data(17:end,2)+data(17:end,3).*1i; 
c=data(17:end,4)+data(17:end,5).*1i; 
filename = strcat(filebase,'_F.txt'); data=load(filename); 
F=data(17:end,2)+data(17:end,3).*1i; 
clear data; 
